		...
		<div class="row align-items-center mt-4">
			...
			<div class="col-md-6">
				<form @submit.prevent="submitForm">
					...
					<div clsas="d-flex justify-content-end mt-2">
...
<script setup>
	...
	const WEB3FORMS_ACCESS_KEY = "edbdcc6b-720b-4de6-93ea-06be7c40909f";
	...
	const SITE_KEY = '6Ldu7gksAAAAACryC4EQDyGJSB9v3_9FylHKztAe';
